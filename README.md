# Introduction
Purpose of this repository is to play with Headless CMS ${\color{lightgreen}Directus}$ locally with/witout containers.

## Requirements
:one: NodeJS 18+

:two: postgres/mysql/Oracle etc

:three: Good IDE like Vscode ${\textsf{\color{yellow}(optional step)}}$

:four: Docker *seperate container* [postgres link](https://github.com/connecteddots/postgres-containers) ${\textsf{\color{yellow}(optional step)}}$

## Environment

<details>
<summary>We need to create a environment file *.env* 👈.</summary><br>
...
SECRET="TDbZp_UjzLRgwQYyAGfG6OiM8iJiZXPu"
...
<img src="./assets/running-docker.png" width="85%" style="aspect-ratio: auto;border:solid 1px yellow"/>

Enjoy 🍉🍉🍉.


### References
:one: [Emojis](https://gist.github.com/rxaviers/7360908)